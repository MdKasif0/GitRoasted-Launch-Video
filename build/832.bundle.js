"use strict";
(self["webpackChunkgitroasted_launch_video"] = self["webpackChunkgitroasted_launch_video"] || []).push([[832],{
...
class Conversion {
    ...
    constructor(options) {
        ...
        if (options.copy !== undefined && options.copy !== false) {
            ...
            if (options.copy.shiftTolerance !== undefined
                && (!(0,misc/* isNumber */.Et)(options.copy.shiftTolerance) || options.copy.shiftTolerance < 0)) {
        ...
        if (options.trim?.end !== undefined && (!(0,misc/* isNumber */.Et)(options.trim.end))) {
    ...
    async _processVideoTrack(track, trackOptions, outputTrackId) {
            ...
            if (startPacket) {
                ...
                if (!this.output.format.supportsTimestampedMediaData) {
                    ...
                    if (this._timestampOffsetAdjusted) {
                        ...
                        const correction = (0,misc/* clamp */.qE)(this._startTimestamp - effectiveStartTimestamp, -this._copyTimestampShiftTolerance, this._copyTimestampShiftTolerance);
        ...
        this.output.addVideoTrack(videoSource, {
            ...
            languageCode: (0,misc/* isIso639Dash2LanguageCode */.Nu)(videoTrackLanguageCode)
    ...
    async _processAudioTrack(track, trackOptions, outputTrackId) {
        ...
        if (!needsTranscode) {
            ...
            const hasDecoderWarmup = src_codec/* NON_PCM_AUDIO_CODECS */.YB.includes(sourceCodec)
                && sourceCodec !== 'flac';
            ...
            if (startPacket) {
                if (!this.output.format.supportsTimestampedMediaData) {
                    ...
                    if (this._timestampOffsetAdjusted) {
                        ...
                        const correction = (0,misc/* clamp */.qE)(this._startTimestamp - startPacket.timestamp, -this._copyTimestampShiftTolerance, this._copyTimestampShiftTolerance);
        ...
        this.output.addAudioTrack(audioSource, {
            // TODO: This condition can be removed when all demuxers properly homogenize to BCP47 in v2
            languageCode: (0,misc/* isIso639Dash2LanguageCode */.Nu)(audioTrackLanguageCode)
